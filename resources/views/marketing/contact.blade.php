            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 items-stretch">
                <a href="mailto:{{ $content['contact']['email'] }}" class="flex flex-col reveal" data-reveal data-delay="100">
                    <div class="group relative flex flex-col flex-1">
                        <div class="relative flex flex-col flex-1 border border-primary/20 p-8 md:p-10 transition-all duration-700 hover:border-primary/40 hover:shadow-[0_0_40px_rgba(139,212,226,0.15)]">
                ...
                <div class="flex flex-col reveal" data-reveal data-delay="340">
                    <div class="group relative flex flex-col flex-1">
                        <div class="relative flex flex-col flex-1 border border-primary/20 p-8 md:p-10 transition-all duration-700 hover:border-primary/40 hover:shadow-[0_0_40px_rgba(139,212,226,0.15)]">
                            <div class="mb-6 flex justify-center">
                                <div class="w-12 h-12 flex items-center justify-center border border-primary/30 transition-all duration-700 group-hover:border-primary group-hover:shadow-[0_0_20px_rgba(139,212,226,0.3)]">
